class HomeController < ApplicationController
  def index
    ...
    @attendances = Attendance.order(created_at: :desc).limit(5)
  ...
  def time_out
    ...
    if attendance
      ...
      attendance.tasks.create(
        title: "Daily Journal - #{attendance.date}",
        description: "Write your daily tasks and reflection for #{attendance.date}"
      )
    end
